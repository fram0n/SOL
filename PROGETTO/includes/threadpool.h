...
typedef struct threadpool_t {
    ...
    pthread_cond_t   condEmpty;    // usata per notificare un worker thread che la coda è vuota
    pthread_cond_t   condFull;    // usata per notificare un worker thread che la coda è piena
    pthread_cond_t   condEnd;     // usata per notificare che l'ultimo worker thread ha finito
    pthread_cond_t   condConn;    //usata per notificare al main che tutti i thread si sono connessi al Collector
    ...
    int connected;            //numero di thread connessi
} threadpool_t;
